...
import (
	...
	"github.com/0xPolygon/polygon-edge/helper/contract"
...
func GenerateGenesisAccountFromFile(
	...
	artifact, err := contract.NewArtifact(filepath)
	if err != nil {
		return nil, err
	}
	...
	return contract.NewContractAccount(config, staking.AddrStakingContract, artifact, constructorParams)
}
